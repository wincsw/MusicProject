...
//this.resize();
		...
		if ( r === 0 ) { this.loadEcosystem( ECO_RED_MENACE ); }
		if ( r === 1 ) { this.loadEcosystem( ECO_SIMPLIFY 	); }
		if ( r === 2 ) { this.loadEcosystem( ECO_MITOSIS 	); }
		if ( r === 3 ) { this.loadEcosystem( ECO_PURPLE 	); }
		if ( r === 4 ) { this.loadEcosystem( ECO_ACROBATS 	); }
